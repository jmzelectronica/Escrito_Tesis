...
poligono  = open("/home/lab-10/Documentos/Marcos_referencia_ok/ned2geodesic/poligono_cuatro/path_ned_torres/path_ecef/path_6.ecef", "r") #leyendo el archivo que me genera geo2ecef
data = poligono.read()
poligono.close()
...
plt.ylabel('geodesico')
plt.show()
#plt.savefig('path_geodesico.png')
np.savetxt('/home/lab-10/Documentos/Marcos_referencia_ok/ned2geodesic/poligono_cuatro/path_ned_torres/path_geo/path_6.geo', geo, delimiter='    ')   # guardando el archivo en lat,lon,h
