...
#poligono  = open("path_6.geo", "r")
poligono  = open("/home/lab-10/Documentos/Marcos_referencia_ok/ned2geodesic/poligono_cuatro/home.poly", "r")
...
plt.show()
#np.savetxt('path_6.ned', ecef, delimiter='    ')   # X is an array
np.savetxt("/home/lab-10/Documentos/Marcos_referencia_ok/ned2geodesic/poligono_cuatro/poli_ecef/home_efre.ecef",  ecef, delimiter='    ')
